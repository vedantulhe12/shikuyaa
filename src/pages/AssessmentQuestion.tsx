...
import { FaClock, FaPlay, FaCheck, FaCheckDouble } from 'react-icons/fa'
          ...
          <div className="max-w-6xl">
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center space-x-4">
                  {questionStatus[selectedQuestion] === 'solved' ? (
                    <span className="inline-flex items-center px-3 py-1 bg-green-50 border border-green-500 rounded text-sm text-green-700">
                      <FaCheckDouble className="w-3 h-3 mr-1" />
                      SUBMITTED
                    </span>
                  ) : (
                ...
                <div className="bg-white">
                  {activeTab === 'code' && (
                    <div className="relative">
                      <div className="absolute left-0 top-0 w-12 h-96 bg-gray-100 border-r pt-4 text-center overflow-hidden">
                        {code.split('\n').map((_, index) => (
                          <div key={index} className="text-xs text-gray-500 leading-6">{index + 1}</div>
                        ))}
                      </div>
                      <textarea
                        value={code}
